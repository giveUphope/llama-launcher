...
Everything lives in `docs/en/` (Chinese originals in [`docs/zh/`](docs/zh/architecture.md) — every page carries a language line back and forth). This is the English landing page; the repository's default page is the Chinese [README.md](README.md), and the two hold the same structure and the same numbers. Pick the page that matches what you want to understand:
