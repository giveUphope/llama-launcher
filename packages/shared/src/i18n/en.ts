...
export const en: Dict = {
  ...
  subcat_security: 'Security & CORS',
  sec_open_endpoint_hint: 'No API key is set and CORS allows every origin: any local web page can call this endpoint. Restrict origins under Params → Security & CORS, or set an API key',
