...
const ICONS: Record<string, string> = {
  ...
  // 二级参数导航
  basic: '<circle cx="12" cy="12" r="9"/><path d="M12 7v5l3 3"/>',
  advanced: '<path d="M12 2l2.5 7.5L22 12l-7.5 2.5L12 22l-2.5-7.5L2 12l7.5-2.5L12 2z"/>',
  sampling: '<path d="M3 12c4-6 8-6 12 0s8 6 6 0"/><circle cx="6" cy="12" r="1.5" fill="currentColor" stroke="none"/><circle cx="18" cy="12" r="1.5" fill="currentColor" stroke="none"/>',
