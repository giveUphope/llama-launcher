...
| Unit tests                     | `pnpm test` (Vitest 4; `packages/core` 25 个测试文件 / 359 用例 + `packages/ui` 7 个测试文件 / 66 用例，turbo 一并运行)                                                          |
