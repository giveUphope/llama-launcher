...
`lint` will fail if the 48 IPC channel constants in `packages/shared/src/types/ipc.ts` and `apps/desktop/src/preload/index.cjs` drift — always re-run it after touching IPC.
