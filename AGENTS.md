...
| Unit tests                     | `pnpm test` (Vitest 4; `packages/core` 25 个测试文件 / 373 用例 + `packages/ui` 8 个测试文件 / 79 用例，turbo 一并运行)                                                          |
